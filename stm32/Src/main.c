...
int main(void) {
	...
	//acc_example_service_subsweeps(0, NULL);
	/* USER CODE END 2 */
...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOB,
			SEN_EN1_Pin | A121_SPI_SS_Pin | SPI_SEL0_Pin | SPI_SEL1_Pin
					| SPI_SEL2_Pin, GPIO_PIN_RESET);

	/*Configure GPIO pin : ALARM_LIGHT_Pin */
	GPIO_InitStruct.Pin = ALARM_LIGHT_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
	HAL_GPIO_Init(ALARM_LIGHT_GPIO_Port, &GPIO_InitStruct);
	...
	/*Configure GPIO pins : SPI_SEL0_Pin SPI_SEL1_Pin SPI_SEL2_Pin */
	GPIO_InitStruct.Pin = SPI_SEL0_Pin | SPI_SEL1_Pin | SPI_SEL2_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
	HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
